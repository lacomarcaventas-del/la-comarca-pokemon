...
export default function Eventos(){
  ...
  <div style={{maxWidth:560}}><Link href="/eventos/temporada-de-novatos" style={{display:"block",textDecoration:"none"}}><img src="/temporada-novatos-2026.jpg.jpg" alt="Temporada de Novatos" style={{width:"100%",height:"auto",display:"block",borderRadius:16,border:"1px solid rgba(255,255,255,.16)"}}/></Link></div></section></main>}