...
const lines=[
  ...
  ["Disney Lorcana","lorcana","Disney Lorcana"],
  ["Dungeons & Dragons","dnd","Dungeons & Dragons"],
  ["Gundam Card Game","gundam","Gundam Card Game"],
  ["Heroclix","heroclix","Heroclix"],
  ["Juegos de Mesa","juegos-mesa","Juegos de Mesa"],
  ["Magic: The Gathering","magic","Magic: The Gathering"],
  ["Modelismo","modelismo","Modelismo"],
  ["One Piece Card Game","onepiece","One Piece Card Game"],
  ["Pokémon TCG","pokemon","Pokémon TCG"],
  ["Weiss Schwarz","weiss","Weiss Schwarz"],
  ["Yu-Gi-Oh!","yugioh","Yu-Gi-Oh!"]
];

export default function Home(){return <div className="siteShell">
  <header className="top siteTop"><Link href="/" className="logoLink"><BrandLogo/></Link><nav className="mainNav navPills"><Link href="/catalogo">Catálogo</Link><Link href="/catalogo">Categorías</Link><a href="#comunidad">Comunidad</a><Link href="/eventos">Eventos</Link></nav><div className="topActions"><Link href="/cuenta">♙ Clientes</Link><Link href="/catalogo" className="cartMini">🛒 Carrito</Link></div></header>
  <main>
