...
export default function Home(){
  return <><header className="top"><b>La Comarca</b><nav className="topNav"><Link href="/cuenta">👤 Mi cuenta</Link><Link className="adminAccess" href="/admin">Administración</Link></nav></header>
