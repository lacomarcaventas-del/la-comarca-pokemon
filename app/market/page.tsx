...
const marketCss = `
.marketHeroVisual{min-height:410px;position:relative;overflow:hidden;border:1px solid rgba(0,238,255,.5);border-radius:18px;background:radial-gradient(circle at 68% 48%,rgba(0,234,255,.13),transparent 25%),radial-gradient(circle at 85% 70%,rgba(255,32,231,.11),transparent 28%),linear-gradient(115deg,#07101c 0%,#0a1424 48%,#12091c 100%);box-shadow:0 18px 55px rgba(0,0,0,.35);padding:58px
...
.marketHeroTitle{position:relative;z-index:2;font-size:82px;line-height:.9;font-weight:900;letter-spacing:-.04em;color:#fff;margin:8px 0 18px;text-shadow:0 0 22px rgba(0,234,255,.18)}
...
.marketHeroPatience{position:absolute;z-index:3;right:58px;top:54px;width:300px;padding:24px 24px 22px;transform:rotate(-4deg);border:1px solid rgba(0,234,255,.3);border-radius:12px;background:rgba(6,13,24,.88);box-shadow:0 12px 35px rgba(0,0,0,.3)}
...
.marketTrust{max-width:1200px;margin:24px auto 0;padding:0 18px;display:grid;grid-template-columns:repeat(4,1fr);gap:0;border-bottom:1px solid rgba(0,234,255,.16)}
...
.marketActions{max-width:1200px;margin:18px auto 0;padding:0 18px;display:grid;grid-template-columns:repeat(3,1fr);gap:14px}
.marketCard{min-height:205px;padding:22px;border:1px solid rgba(0,234,255,.22);border-radius:15px;background:linear-gradient(145deg,#0d1725,#07101a);box-shadow:0 12px 30px rgba(0,0,0,.2);color:#fff;text-decoration:none;transition:.18s ease;position:relative;overflow:hidden}
...
.marketContact{max-width:1200px;margin:18px auto 0;padding:0 18px}
