...
.marketHeroBox{position:relative;min-height:390px;overflow:hidden;border:1px solid rgba(0,238,255,.72);border-radius:18px;background:radial-gradient(circle at 72% 48%,rgba(0,234,255,.16),transparent 23%),radial-gradient(circle at 88% 75%,rgba(255,32,231,.15),transparent 30%),linear-gradient(115deg,#07111d,#0a1727 52%,#15091d);box-shadow:0 20px 55px rgba(0,0,0,.4);padding:46px 58px}
...
.marketHeroMain{position:relative;z-index:3;margin-top:17px;color:#fff;font-size:27px;font-weight:900}.marketHeroEn{position:relative;z-index:3;margin-top:6px;color:#bdd4e6;font-size:16px;letter-spacing:.2em}
.marketHeroSub{position:relative;z-index:3;margin-top:20px;color:#fff;font-size:21px;font-weight:800}.marketHeroSubEn{position:relative;z-index:3;margin-top:5px;color:#a9c2d5;font-size:15px}
.marketPatience{position:absolute;z-index:4;right:28px;top:30px;width:270px;padding:22px 23px;border:1px solid rgba(255,32,231,.45);border-radius:13px;background:rgba(4,10,19,.88);box-shadow:0 14px 40px rgba(0,0,0,.4);transform:rotate(-4deg)}
...
.marketCards{position:absolute;right:85px;bottom:-45px;width:360px;height:250px;transform:rotate(8deg);opacity:.95}.marketCardArt{position:absolute;width:140px;height:200px;border-radius:17px;border:1px solid rgba(0,234,255,.55);background:linear-gradient(145deg,#182b42,#07101a);box-shadow:0 0 25px rgba(0,234,255,.1)}.marketCardArt:nth-child(1){left:8px;top:45px;transform:rotate(-16deg)}.marketCardArt:nth-child(2){left:108px;top:0;border-color:rgba(255,32,231,.55);transform:rotate(5deg)}.marketCardArt:nth-child(3){left:208px;top:38px;transform:rotate(19deg)}
...
.marketInfo{max-width:1200px;margin:10px auto 0;padding:0 18px;display:grid;grid-template-columns:repeat(3,1fr)}
...
.marketActions{max-width:1200px;margin:10px auto 0;padding:0 18px;display:grid;grid-template-columns:repeat(2,1fr);gap:14px}
.marketAction{min-height:190px;display:block;padding:22px;border:1px solid rgba(0,234,255,.34);border-radius:16px;background:linear-gradient(145deg,#0d1b2b,#07101a);box-shadow:0 13px 32px rgba(0,0,0,.25);text-decoration:none;transition:transform .18s ease,border-color .18s ease;position:relative;overflow:hidden}
...
.marketBottom{max-width:1200px;margin:12px auto 0;padding:0 18px;display:grid;grid-template-columns:1.05fr .95fr;gap:14px;align-items:stretch}
.marketBottom .marketEmailBox{max-width:none;margin:0;padding:0}
.marketReception{padding:20px 22px;border:1px solid rgba(240,206,152,.5);border-radius:15px;background:linear-gradient(145deg,#0d1b2b,#0b111a);box-shadow:0 13px 32px rgba(0,0,0,.25)}
.marketReceptionHead{display:flex;gap:14px;align-items:flex-start}
.marketReceptionIcon{font-size:31px;color:#f0ce98;text-shadow:0 0 14px rgba(240,206,152,.35)}
.marketReception h3{margin:0;color:#fff;font-size:16px;line-height:1.2}
.marketReception h3 span{display:block;margin-top:5px;color:#f0ce98;font-size:10px;letter-spacing:.14em}
.marketReception p{margin:9px 0 0;color:#b8cddd;font-size:12px;line-height:1.5}
.marketCities{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:18px}
.marketCity{min-height:65px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;border:1px solid rgba(240,206,152,.22);border-radius:10px;background:rgba(240,206,152,.035)}
.marketCityIcon{font-size:17px;color:#f0ce98}.marketCity small{color:#fff;font-size:9px;letter-spacing:.08em;font-weight:800}
@media(max-width:850px){.marketHeroBox{min-height:500px;padding:42px 28px}.marketTitle{font-size:60px}.marketTitleAccent{width:270px}.marketPatience{right:25px;top:auto;bottom:24px;width:250px}.marketCards{display:none}.marketInfo{grid-template-columns:1fr 1fr}.marketInfoItem:nth-child(2){border-right:0}.marketInfoItem:nth-child(-n+2){border-bottom:1px solid rgba(0,234,255,.15)}.marketActions{grid-template-columns:1fr}.marketEmailInner{grid-template-columns:1fr;gap:17px}.marketEmailNote{border-left:0;border-top:1px solid rgba(0,234,255,.2);padding:15px 0 0}.marketBottom{grid-template-columns:1fr}.marketCities{grid-template-columns:repeat(2,1fr)}}
  ...
  return <div className="siteShell marketPage">
    ...
    <main>
      ...
      <section className="marketActions">
        ...
        <a className="marketAction" href="/market/formato-cartas-para-evaluacion.xlsx" download>
          <div className="marketActionIcon">▤</div>
